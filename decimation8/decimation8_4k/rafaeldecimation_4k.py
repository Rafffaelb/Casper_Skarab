...
def get_data():
	...
	a_1=struct.unpack('>2048L',skarabs[0].read('mem_left_0_0',2048*4,0))
	a_2=struct.unpack('>2048L',skarabs[0].read('mem_left_0_1',2048*4,0))
	#a_2 = a_1
...
def plot_spectrum():
	...
	matplotlib.pylab.plot(
                np.linspace(-4096./2,4096./2-1,4096)
                    *375./4096.+actual_channels_ddc_centre_freq/1.0e6,
                interleave_a,
                'b'
        )

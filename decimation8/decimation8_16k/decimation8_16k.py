...
def get_data():
	...
	a_1=struct.unpack('>8192L',skarabs[0].read('mem_left_0_0',8192*4,0))
	a_2=struct.unpack('>8192L',skarabs[0].read('mem_left_0_1',8192*4,0))
	#a_2 = a_1
...
def plot_spectrum():
	...
	print(np.linspace(-16384./2,16384./2-1,16384).shape,interleave_a.shape)
	matplotlib.pylab.plot(
                np.linspace(-16384./2,16384./2-1,16384)
                    *375./16384.+actual_channels_ddc_centre_freq/1.0e6,
                interleave_a,
                'b'
        )
...
if __name__ == '__main__':
        ...
        p.add_option('-l', '--acc_len', dest='acc_len', type='int',default=4096,
...
try:
	...
	for i in range(skarab_adc_num):
        ...
        for i in range(skarab_num):
            ...
            skarabs[i].write_int('fft_shift', 2047)

...
def plot_spectrum():
	...
	print(np.linspace(-8192./2,8192./2-1,8192).shape,interleave_a.shape)
	matplotlib.pylab.plot(
                np.linspace(-8192./2,8192./2-1,8192)
                    *375./8192.+actual_channels_ddc_centre_freq/1.0e6,
                interleave_a,
                'b'
        )
...
if __name__ == '__main__':
        ...
        p.add_option('-l', '--acc_len', dest='acc_len', type='int',default=65536,

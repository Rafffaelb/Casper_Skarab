...
def get_data():
	...
	#a_2=struct.unpack('>1024L',skarabs[0].read('mem_left_0_1',1024*4,0))
      	...
      	#a_1=struct.unpack('>1024L',skarabs[0].read('mem_right_0_0',1024*4,0))
	#a_2=struct.unpack('>1024L',skarabs[0].read('mem_right_0_1',1024*4,0))
      
      	#a_1=struct.unpack('>1024L',skarabs[0].read('mem_left_0_2',1024*4,0))
	#a_2=struct.unpack('>1024L',skarabs[0].read('mem_left_0_3',1024*4,0))
      
        a_1=struct.unpack('>1024L',skarabs[0].read('mem_right_0_2',1024*4,0))
	a_2=struct.unpack('>512L',skarabs[0].read('mem_right_0_3',512*4,0))
        #a_2=a_1
